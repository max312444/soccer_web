...
const posts = ref([
  { title: '가이드 1 - 팀 검색 방법', content: '팀 이름을 검색창에 입력하고 입력완료 버튼을 누르면 정보가 나옵니다.' },
  { title: '가이드 2 - 팀 상세 정보 확인 방법', content: '팀 검색 다음에 원하는 팀을 클릭하면 팀의 정보(로고, 국가, 창단 연도, 홈구장 정보, 공식 웹 사이트, 팀 색상)을 확인할 수 있습니다.' },
  { title: '가이드 3 - 경기 일정 확인 방법', content: '메뉴 있는 경기 일정 메뉴로 이동한 다음 원하는 날짜가 있는 주로 변경하면 경기 일정을 확인 할 수 있습니다.' },
  { title: '가이드 4 - 리그 순위표 확인 방법', content: '상단 메뉴의 ‘순위표’를 클릭하면 각 리그의 현재 시즌 순위를 확인할 수 있습니다. 홈 화면 오른쪽에는 리그별 1위 팀이 요약되어 표시됩니다.' },
